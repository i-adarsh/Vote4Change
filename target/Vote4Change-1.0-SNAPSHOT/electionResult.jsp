...
<%
    ...
    displayBlock.append("<tr><th>Candidate Id</th><th>Candidate Name</th><th>Candidate Name</th><th>Party</th><th>Party</th><th>Symbol</th><th>City</th><th>Vote Count</th><th>Vote %</th></tr>");
    while(it.hasNext()){
