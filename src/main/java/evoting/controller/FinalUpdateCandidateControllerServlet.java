 ...
 * @author adarshkumar
 */
public class FinalUpdateCandidateControllerServlet extends HttpServlet {
        ...
        try{
            ...
            for(FileItem fit : multiList){
                if(fit.isFormField()){
                    ...
                    //Image
                    System.out.println("inside img else");
            ...
            boolean result = CandidateDAO.updateCandidate(objValues.get(1), inp, objValues.get(2),objValues.get(0));
            if (result){
